    ...
    $containerBuilder->addDefinitions([
        ...
        SettingsInterface::class => function ($DIContainer, $DIfactoryDefinition) {
			...
			$aValue = [
                ...
                'logger' => [
                    'name' => 'slim-app',
                    'path' => isset($_ENV['docker']) ? 'php://stdout' : $psr4PathHelper->aliasToFull("App\\var\\logs",true) . "\\app.log",
                    'level' => Logger::DEBUG,
                ],
				'tempDir' => $psr4PathHelper->aliasToFull("App\\var\\temp",true),
				'cacheDir' => $psr4PathHelper->aliasToFull("App\\var\\cache",true),
				'components' => [
					'Hwg' => [
						'class' => 'Hwg\\app',
						'admin' => 'Hwg\\app\\admin',
