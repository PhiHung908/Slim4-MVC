...
#[FastRoute('[GET,POST]')]
class DsAction extends \hSlim\base\AbstractAction
{
	/**
	...
	public function __construct(protected \Psr\Log\LoggerInterface &$logger, protected \Psr\Container\ContainerInterface &$c) {
		...
		parent::__construct($logger, $c, __NAMESPACE__ . '\DsAsset'); //is direct asset class
	}
	//*/
    ...
    {	
		...
		$viewData['layout'] = 'ds/layout.php';
		return $this->render('ds/home.php', $viewData);
...
class DsAsset extends \hSlim\base\AbstractAsset
{
