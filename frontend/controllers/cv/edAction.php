...
#[FastRoute('[GET,POST]')]
class EdAction extends \hSlim\base\AbstractAction
{
	/**
	...
	public function __construct(protected \Psr\Log\LoggerInterface &$logger, protected \Psr\Container\ContainerInterface &$c) {
		...
		parent::__construct($logger, $c, __NAMESPACE__ . '\EdAsset'); //is direct asset class
	}
	//*/
    ...
    {	
        ...
        $this->logger->info("cv list was viewed.");
		
		$viewData['layout'] = 'ed/layout.php';
		return $this->render('ed/home.php', $viewData);
...
class EdAsset extends \hSlim\base\AbstractAsset
{
